window.DRAGON_ARCHIVE_DATA = {
  ...
  magicCategories: [
    ...
    { id: "invocations", title: "Eldritch Invocations", subtitle: "Always-active invocations plus the Pact of the Invoker pool. Only one Invoker option can be active." },
  ...
  magicCards: [
    ...
    { id: "mask-many-faces", category: "invocations", name: "Mask of Many Faces", tag: "Invocation", icon: "◑", mini: "At-will disguise layer.", type: "Eldritch Invocation", cost: "At Will", range: "Self", duration: "1 hour", prepared: true, alwaysActive: true, detail: "Allows Ryo to cast Disguise Self without expending a spell slot." },
    { id: "heart-of-the-pact", category: "invocations", name: "Heart of the Pact", tag: "Homebrew Invocation", icon: "✧", mini: "Tome cantrip core.", type: "Homebrew Invocation", cost: "Passive", range: "Self", duration: "Persistent", prepared: true, alwaysActive: true, detail: "Grants the Pact of the Tome cantrip layer: Guidance, Mage Hand and Resistance." },
    { id: "agonizing-blast", category: "invocations", name: "Agonizing Blast", tag: "Invoker Pool", icon: "✦", mini: "CHA to Eldritch Blast damage.", type: "Invoker Invocation", cost: "Active Invoker Slot", range: "Self", duration: "Until switched", prepared: true, invokerPool: true, detail: "When active, add Charisma modifier to each Eldritch Blast beam's damage." },
    { id: "beast-speech", category: "invocations", name: "Beast Speech", tag: "Invoker Pool", icon: "♧", mini: "Speak with animals at will.", type: "Invoker Invocation", cost: "Active Invoker Slot", range: "Self", duration: "Until switched", prepared: true, invokerPool: true, detail: "When active, Ryo can cast Speak with Animals at will without expending a spell slot." },
    { id: "eyes-rune-keeper", category: "invocations", name: "Eyes of the Rune Keeper", tag: "Invoker Pool", icon: "☷", mini: "Read all writing.", type: "Invoker Invocation", cost: "Active Invoker Slot", range: "Self", duration: "Until switched", prepared: true, invokerPool: true, detail: "When active, Ryo can read all writing. Useful for ancient scripts, ruins and archive work." },
